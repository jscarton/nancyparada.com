...
<div class="wrap">
    ...
    <div id="yit-header">
        <div id="logo"></div>
        <div id="spot">
            <a href="http://www.yithemes.com" target="_blank" title="Your Inspiration Themes"><?php _e( 'DOWNLOAD <strong>HIGH QUALITY</strong> WORDPRESS THEMES <strong>FOR FREE</strong>', 'yit' ) ?></a>
        </div>
        <div id="info">
